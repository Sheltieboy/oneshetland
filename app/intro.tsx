...
const SLIDES: Slide[] = [
  {
    ...
    body:  'Your home for everything Shetland — built locally, for the islands.',
    icon:  'compass',
    color: '#12B3D6',
    bg:    colors.navy,
  },
  {
    title: 'Marketplace',
    body:  'Wallet payments, bookings, loyalty stamps and points, exclusive offers, local shopping.',
  ...
  {
    title: 'Fetch',
    body:  'Need something picked up? Request a driver. Or become a Driver and earn money from the request or create your own run for people to request into.',
    icon:  'truck',
  ...
  {
    title: 'Shifts',
    body:  'Short-term hires and planned work — find a job for tonight or for next month.',
    icon:  'briefcase',
  ...
  },
  {
    ...
    body:  "Sign in once and use everything. We're just getting started — new features land regularly.",
    icon:  'rocket',
    color: '#12B3D6',
    bg:    colors.navy,
    cta:   'Get started',
